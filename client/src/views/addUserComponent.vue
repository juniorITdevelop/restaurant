<template>
  <div class="component-wrapper">
    <div class="header-panel">
      <h1 class="header-text">Створення нового користувача системи</h1>
      <div class="control-buttons"></div>
    </div>
    <div class="work-area">
      <input id="name" type="text" placeholder="Ім'я" autocomplete="none" v-model="name"/>
      <input id="surname" type="text" placeholder="Прізвище" autocomplete="none" v-model="surname"/>
      <input id="birdthDay" type="date" v-model="birdthDay"/>
      <select name id="postName" placeholder="Посада"  v-model="postName">
      ...
      <select name id="postId" placeholder="ID посади" v-model="postId">
      ...
      <input id="password" type="text" placeholder="Пароль" v-model="password"/>
      <input id="phone" type="text" placeholder="Телефон" v-model="phone"/>
      <input id="email" type="text" autocomplete="none" placeholder="Електронна пошта" v-model="email"/>
...
export default {
  ...
  methods: {
    ...
    handleSubmit(e) {
      ...
      formData.append('birdthDay', this.birdthDay);
      formData.append('postId', this.postId);
      formData.append('postName', this.postName);
      formData.append('password', this.password);
      formData.append('phone', this.phone);
      formData.append('email', this.email);
      this.axios.post('http://localhost:3000/api/addUser', formData, {
        headers: {
